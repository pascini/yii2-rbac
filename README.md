...
# Yii2-rbac [![Total Downloads](https://img.shields.io/packagist/dt/pascini/yii2-rbac.svg?style=flat-square)](https://packagist.org/packages/pascini/yii2-rbac) [![Software License](https://img.shields.io/badge/license-MIT-brightgreen.svg?style=flat-square)](LICENSE.md)
...
- Integrated with [Yii2-user](https://github.com/pascini/yii2-user) - flexible user management module
...
[Read the Documentation for v1.0.0-alpha](https://github.com/pascini/yii2-rbac/blob/1.0.0-alpha/docs/README.md)

## Support

If you have any questions or problems with Yii2-rbac you can ask them on [our forum](http://pascini.com).
