...
use pascini\rbac\models\Search;
...
abstract class ItemControllerAbstract extends Controller
{
    /**
     * @param  string $name
     * @return \pascini\rbac\models\Role|\pascini\rbac\models\Permission
     */
    ...
    {
        /** @var \pascini\rbac\models\Role|\pascini\rbac\models\Permission $model */
